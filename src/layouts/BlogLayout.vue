            ...
            <div class="sidebar-widget author-info">
              ...
              <div class="widget-content">
                <div class="author-avatar">
                  <img :src="authorInfo.avatar || 'https://placeholder.pics/svg/150'" alt="博主头像">
                </div>
                <h4 class="author-name">{{ authorInfo.name || '博主名称' }}</h4>
                <p class="author-description">{{ authorInfo.description || '全栈开发工程师，热爱技术和分享。' }}</p>
                <div class="social-links">
                  <a href="#" title="GitHub"><el-icon><i-ep-link /></el-icon></a>
                  <a href="#" title="Email"><el-icon><i-ep-message /></el-icon></a>
                </div>
              </div>
            </div>
              ...
              <div class="widget-content">
                <ul>
                  <li>
                    ...
                    <span>文章数：{{ stats.postCount || 0 }}</span>
                  </li>
                  <li>
                    <el-icon><i-ep-folder /></el-icon>
                    <span>分类数：{{ stats.categoryCount || 0 }}</span>
                  </li>
                  <li>
                    <el-icon><i-ep-collection-tag /></el-icon>
                    <span>标签数：{{ stats.tagCount || 0 }}</span>
                  </li>
                  <li>
                    <el-icon><i-ep-view /></el-icon>
                    <span>总访问量：{{ stats.totalViews || 0 }}</span>
                  </li>
                </ul>
              </div>
            </div>
              ...
              <div class="widget-content">
                <ul>
                  <li v-for="category in categories" :key="category.id">
                    <router-link :to="`/blog/categories/${category.id}`">
                      {{ category.name }}
