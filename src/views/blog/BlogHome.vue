...
.hero-glow-field { position: absolute; z-index: -1; inset: 0; overflow: hidden; pointer-events: none; box-shadow: inset 0 0 180px 28px rgb(116 91 67 / 5%); }.hero-glow-field::before, .hero-glow-field::after { position: absolute; display: block; width: 76%; height: 30%; border-radius: 50%; background: linear-gradient(103deg, transparent 6%, rgb(207 157 104 / 12%) 38%, rgb(235 215 187 / 18%) 58%, transparent 94%); content: ''; filter: blur(18px); transform: rotate(-15deg); animation: hero-orbit 17s ease-in-out infinite alternate; }.hero-glow-field::before { top: 8%; right: -8%; }.hero-glow-field::after { right: -4%; bottom: 12%; background: linear-gradient(103deg, transparent 4%, rgb(127 150 130 / 10%) 42%, rgb(235 225 205 / 15%) 62%, transparent 94%); animation-delay: -8s; }.hero-light-ribbon { position: absolute; display: block; width: 80%; height: 84px; border-radius: 50%; background: linear-gradient(90deg, transparent 4%, rgb(215 172 122 / 12%) 36%, rgb(239 224 202 / 20%) 60%, transparent 96%); filter: blur(13px); opacity: .78; transform: rotate(-14deg); animation: hero-ribbon-flow 15s ease-in-out infinite alternate; }.hero-light-ribbon--one { top: 20%; right: -12%; }.hero-light-ribbon--two { top: 43%; right: -2%; background: linear-gradient(90deg, transparent 4%, rgb(139 158 137 / 10%) 40%, rgb(237 227 209 / 17%) 64%, transparent 96%); animation-delay: -5s; transform: rotate(-8deg) scale(.84); }.hero-light-ribbon--three { right: -9%; bottom: 15%; background: linear-gradient(90deg, transparent 4%, rgb(199 147 99 / 9%) 38%, rgb(235 219 196 / 15%) 63%, transparent 96%); animation-delay: -10s; transform: rotate(-19deg) scale(.72); }.hero-glow { position: absolute; display: block; border-radius: 50%; filter: blur(2px); opacity: .7; animation: hero-glow-drift 9s ease-in-out infinite alternate; }.hero-glow::before { position: absolute; top: 50%; left: 50%; width: 240px; height: 170px; border-radius: 48% 52% 58% 42%; background: radial-gradient(ellipse, rgb(216 163 110 / 15%), transparent 70%); content: ''; filter: blur(25px); transform: translate(-50%, -50%); animation: hero-aura 11s ease-in-out infinite alternate; }.hero-glow--one { top: 18%; right: 16%; width: 8px; height: 8px; background: #d8a36e; box-shadow: 0 0 28px 12px rgb(216 163 110 / 18%); }.hero-glow--two { top: 31%; right: 29%; width: 6px; height: 6px; background: #9aa78f; box-shadow: 0 0 24px 9px rgb(154 167 143 / 16%); animation-delay: -3s; }.hero-glow--three { right: 8%; bottom: 23%; width: 7px; height: 7px; background: #d6b895; box-shadow: 0 0 26px 10px rgb(214 184 149 / 14%); animation-delay: -6s; }
