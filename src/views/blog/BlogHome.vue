...
@keyframes hero-haze { from { background-position: 0% 0%, 100% 100%, 0% 50%; opacity: .72; } to { background-position: 7% 4%, 94% 96%, 100% 50%; opacity: 1; } }
