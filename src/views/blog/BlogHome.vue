...
.hero-title { display: flex; min-height: clamp(90px, 10vw, 120px); align-items: center; justify-content: center; gap: .18em; margin: 0; font-size: clamp(42px, 7.5vw, 92px); font-weight: 800; letter-spacing: -.065em; line-height: 1.08; text-align: center; white-space: nowrap; opacity: .06; transform: translateY(5px) scale(.985); transition: opacity .9s cubic-bezier(.22, .8, .25, 1), transform .9s cubic-bezier(.22, .8, .25, 1); }.hero-title--ready { opacity: 1; transform: translateY(0) scale(1); }.hero-title__accent { color: var(--home-accent); }
